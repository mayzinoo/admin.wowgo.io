                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="header-top-wraper">
                            <div class="row">
								...
								<li><a data-toggle="collapse" data-target="#demo" href="Admin/bankinfo">Bank Info</a></li>
								<li><a data-toggle="collapse" data-target="#demo" href="Admin/deposit_request">Deposit Request</a></li>
								<li><a data-toggle="collapse" data-target="#demo" href="Admin/withdrawal_request">Withdrawal Request</a></li>
								<li><a data-toggle="collapse" data-target="#demo" href="Admin/statistics">Statistics</a></li>
								<li><a data-toggle="collapse" data-target="#demo" href="Admin/tipsend">Tipsend</a></li>
								<li><a data-toggle="collapse" data-target="#demo" href="Admin/chat">Chat Messages</a></li>
